...
function Scrollbar(e) {
  ...
  function x(e) {
    ...
    l.touch
      ? (o[p](a.start, v, d), o[p](a.move, w, d), o[p](a.end, b, c))
      : (o[p](i.start, v, d), r[p](i.move, w, d), r[p](i.end, b, c));
  }
  function y() {
    ...
    0 === r.length &&
      ...
      a.draggable && t.params.scrollbar.el && x("on"),
      i &&
...
function Zoom(e) {
  ...
  function y(e) {
    ...
    if (
      ...
      return;
    let i, n, l, o, c, h, m, f, g, v, w, b, x, y, E, T, S, C;
    t.params.cssMode &&
      ((t.wrapperEl.style.overflow = "hidden"),
  ...
  Object.defineProperty(t.zoom, "scale", {
    ...
    Object.assign(t.zoom, { enable: z, disable: O, in: y, out: E, toggle: T });
}
function Lazy(e) {
  let { swiper: t, extendParams: s, on: a, emit: i } = e;
  s({
...
function A11y(e) {
  ...
  function w() {
    ...
    t.slides.each((s, a) => {
      ...
      t.navigation && t.navigation.$nextEl && (m = t.navigation.$nextEl),
      t.navigation && t.navigation.$prevEl && (w = t.navigation.$prevEl),
      m && m.length && g(m, r, e.nextSlideMessage),
    ...
    setTranslate: () => {
      ...
      for (let i = 0; i < e.length; i += 1) {
        ...
        if (
          ...
          0 === e.length &&
            (e = createShadow(a, r, t.isHorizontal() ? "left" : "top")),
            0 === s.length &&
              (s = createShadow(a, r, t.isHorizontal() ? "right" : "bottom")),
